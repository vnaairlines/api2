...
public class BackendController {
    ...
    public Iterable<User> getAllUser() {
       Iterable<User> User_iterable = userRepository.findAll();
       
       return User_iterable;

       /* return userRepository.findAll().map(alluser -> {
            LOG.info("Reading all user from database.");
            return alluser;
        }).orElseThrow(() -> new UserNotFoundException("No users could be found in the database."));*/
    }
